...
async function loadTeacher() {
    ...
    console.log('Debug - votedTeachers:', votedTeachers, 'votedArray:', votedArray, 'for teacherId:', teacherId);
...
document.getElementById('rating-form').addEventListener('submit', async (e) => {
    ...
    if (!votedArray.includes(teacherId.toString())) {
        ...
        console.log('Debug - Added vote for teacher', teacherId, 'New votedTeachers:', getCookie('votedTeachers'));
    } else {
